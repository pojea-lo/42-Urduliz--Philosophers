...
t_sphilo	*ft_data(int i, t_dat *in)//carga datos iniciales a las variables de la estructura del filo
{
	...
	phil->in->impi = 0;//con philos impares, con 0 espera el último y con 1 el primero
	phil->in->impp = 0;//con philos impares, con 0 espera el último y con 1 el primero
