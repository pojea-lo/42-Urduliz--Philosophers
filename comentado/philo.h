...
typedef struct	s_dat
{
	...
	int				impi;//estado para filosofos impares, que hace esperar al primero (1) o al ultimo (0)
	int				impp;//estado para filosofos impares, que hace esperar al primero (1) o al ultimo (0)
...
typedef struct	s_sphilo//estructura para cada filosofo
{
	...
	int			sp;//estado de primera pasada para la primera condicion de muerte y cuenta numero de comidas
	...
	int			ss;//estado si ha dormido, 0 si no / 1
	t_dat		*in;
